...
Route::get('/dashboard', function () {
    ...
    // On prépare le tableau de statistiques selon le rôle [cite: 20]
    if ($user->role === 'admin') {
        $stats = [
            'total_eleves' => User::where('role', 'apprenant')->count(),
            'total_formations' => Formation::count(),
            // On récupère les 5 dernières notes globales pour l'admin [cite: 48]
        ...
        $stats = [
            ...
            'dernieres_notes' => Note::where('user_id', $user->id)->with('quiz')->latest()->take(3)->get(), // [cite: 47]
    ...
    // On passe les statistiques à la vue pour affichage [cite: 56]
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        // Gestion des Questions (Liées au QuizController comme tu l'as défini)
    ...
    // 4. WILDCHRDS / PARAMÈTRES (À mettre TOUJOURS en dernier)
